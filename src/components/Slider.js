...
import simg1 from '../img/carousel-1.jpg'
import simg2 from '../img/carousel-2.jpg'
            ...
            <div className="container-fluid p-0">
                <div className="owl-carousel header-carousel position-relative">
                    <div className="owl-carousel-item position-relative">
                        <img className="img-fluid" src={simg2} alt="" />
                            ...
                            <div className="container">
                                <div className="row justify-content-start">
                                    <div className="col-10 col-lg-8">
                                        ...
                                        <Link to="/search" className="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Search A Job</Link>
                                        <Link to="saerch" className="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Find A Talent</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* <div className="owl-carousel-item position-relative">
                        <img className="img-fluid"  src={simg1} alt="" />
                        <div className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style={{background: "rgba(43, 57, 64, .5)"}}>
                            <div className="container">
                                <div className="row justify-content-start">
                                    <div className="col-10 col-lg-8">
