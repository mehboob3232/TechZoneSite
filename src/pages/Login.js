...
import limg1 from '../img/login.png';
    ...
    return (
        <>
            ...
            <form onSubmit={(e) => e.preventDefault()} style={{ width: "600px", margin: "20px auto" }}>
                <img src={limg1} className='mx-auto d-flex' style={{ width: "90px", height: "90px" }} />
                <h3 className='text-center text-primary' >Login Account</h3>
                <div className="mb-3">
                ...
                <button type="submit" onClick={handleLogin} className="btn btn-primary" disabled={(isLoading == true) ? true : false}> {isLoading ? "Loading..." : "Login"}</button>
            </form>
        </>
    )
}
