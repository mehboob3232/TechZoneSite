    ...
    <div className="container">
        ...
        <div className="row g-4">
            <div className="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <i class="fa-solid fa-3x fa-pen-to-square text-primary mb-4" style={{color: "#00b37a;"}}></i>
            ...
            <div className="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <i class="fa-solid fa-3x fa-desktop text-primary mb-4"  style={{color: "#00b37a;"}}></i>
                    ...
                    <div className="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <i class="fa-solid fa-3x fa-mobile-screen-button text-primary mb-4" style={{color: "#00b37a;"}}></i>
                    ...
                    <div className="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        ...
                        <i class="fa-solid fa-3x fa-palette text-primary mb-4" style={{color: "#00b37a;"}}></i>
                    ...
                    <div className="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <i class="fa-solid fa-3x fa-bullhorn text-primary mb-4" style={{color: "#00b37a;"}}></i>
                    ...
                    <div className="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <i class="fa-brands fa-3x  fa-wordpress text-primary mb-4" style={{color: "#00b37a;"}}></i>
